...
bkk_network.snapped <- snapPointsToLines2(bkk_network, roads_bmr)
spk_network.snapped <- snapPointsToLines2(spk_network, roads_bmr)
```
...
rm(bkk_network.snapped)
rm(spk_network.snapped)
```
